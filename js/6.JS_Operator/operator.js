...
/*
    ...
    - % : 나머지
*/
console.log(10/3);      // 3.33333      자바에서는 3
console.log('십'/3);    // NaN          자바에서는 컴파일에러
...
console.log(typeof +'10');     // noumber / 10
console.log(+true);            // 1,  +false는 0이나옴
...
console.log('A method :' + 20 + 10 + 'Sec');    // 2010 이 출력
...
console.log(10 === '10')        // false (type까지 같이 비교)
...
/*
    ...
    - <= : 좌항이 우항보다 작거나 같다
*/
console.log(10 > '9');      // true (type을 비교하지 않음)
...
let result2 = number % 2 ? '홀수' : '짝수' ;      // 위에꺼와 같은 형태 1이면 true 0이면 false
console.log(result2);
