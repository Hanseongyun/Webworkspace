/*
    if else 문
    - 조건식이 true일 경우 if 코드 블럭 실행, false일 경우 else 코드블럭 실행
...
console.log(weekString);        // 수요일,  break가 없으면 수요일목요일금토요일
...
*/
let randomNumber = Math.random();   // 0~1 사이의 임의의 실수값
