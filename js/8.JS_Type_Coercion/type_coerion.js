...
/*
    문자열 타입으로 형변환
    - + 연산자를 사용할 때 좌항과 우항중 하나라도 문자열이 존재하면 문자열이 아닌 항을 문자열로 변경하여 연결 연산함
*/
console.log(1 + '1');       // 11
...
/*
    숫자 타입으로 형변환
    - + 연산자를 제외한 나머지 산술 연산 혹은 대소 비교 연산에 대하여 좌,우항중 하나라도 숫자가 존재하면 숫자가 아닌 항을 숫자 타입으로 변경하여 연산을 진행
*/
console.log('1' - 0);       // 1
...
/*
    ...
    - 문자열일 경우 parseInt(), parseFloat() 메서드로 사용 가능
    - + 단항연산자 사용 가능
*/
