...
// let letVariable = 10;
// let letVariable = 10;        // 중복 선언 불가 (let), 컴파일언어만 빨간줄 그어짐(여기서는 vs코드가 인식해서 빨간줄)
...
// ReferenceError: letHoisting is not defined      // << let letHoisting = 10; 이 주석처리 됬을때
...
*/
const ASSIGNMENT = 10;
// TypeError: Assignment to constant variable. (재할당 불가)
// ASSIGNMENT = 11;

// SyntaxError : Missing initializer in const declaration
//const INITIALIZATION;        // 초기화x
